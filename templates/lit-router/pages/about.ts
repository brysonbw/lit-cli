  ...
  render(): TemplateResult {
    return html`<div>
      ...
      <p>
        ...
        <a href="https://lit.dev/" target="_blank">Lit</a> projects. It uses the
        <a href="https://vite.dev/" target="_blank">Vite</a> build tool (server
        and bundler), which builds on the (Lit)
        <a
      ...
      <p>
        ...
        <b
          ...
          humanity</b
        >. Also, you have agency over your life so think and act on your ideas.
        <b>Remember, anything is possible</b> - keep moving forward and keep
        making progress.
      </p>
